...
/*
	Pool allocator with fixed-size pages. Constant-time alloc/free for
	fixed-size structs such as ContactConstraint.
*/
#ifndef ENGINE_32_PHYSICS_PAGED_ALLOCATOR_H
#define ENGINE_32_PHYSICS_PAGED_ALLOCATOR_H
