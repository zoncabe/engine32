...
/*
	First-fit heap allocator. Sized by whoever creates it: the world asks
	for room for as many bodies as the scene will build, nothing more.
*/
#ifndef ENGINE_32_PHYSICS_HEAP_H
#define ENGINE_32_PHYSICS_HEAP_H
...
/* 'size' in bytes, taken from the system heap once, here. Every block
   handed out carries a PhysicsHeader in front, so count that per object. */
