...
#ifndef ENGINE_32_PHYSICS_SETTINGS_H
#define ENGINE_32_PHYSICS_SETTINGS_H

#include "physics/math/e32_math_common.h"

#define PHYSICS_SLEEP_LINEAR      0.01_fp
#define PHYSICS_SLEEP_ANGULAR     0.052360_fp   /* 3 degrees in radians */
#define PHYSICS_SLEEP_TIME        0.4_fp
#define PHYSICS_BAUMGARTE         0.2_fp
#define PHYSICS_PENETRATION_SLOP  0.01_fp

#define PHYSICS_SOLVER_ITERATIONS 8
#define PHYSICS_TIMESTEP          0.016667_fp   /* 1/60 */
...
#define PHYSICS_AABB_FATTENER     0.1_fp
...
#define PHYSICS_MAX_TIMESTEP      0.05_fp   /* 1/20 */
